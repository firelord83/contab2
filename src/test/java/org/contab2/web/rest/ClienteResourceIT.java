...
import org.contab2.domain.Cliente;
import org.contab2.repository.ClienteRepository;
...
class ClienteResourceIT {
    ...
    @Test
    @Transactional
    void checkNomeClienteIsRequired() throws Exception {
    ...
    void putNewCliente() throws Exception {
        ...
        updatedCliente.nomeCliente(UPDATED_NOME_CLIENTE).partitaIVA(UPDATED_PARTITA_IVA).indirizzo(UPDATED_INDIRIZZO).tipo(UPDATED_TIPO);
    ...
    void partialUpdateClienteWithPatch() throws Exception {
        ...
        partialUpdatedCliente.indirizzo(UPDATED_INDIRIZZO);
